const quotes = [
     ...
     {"quote": "What we do today, right now, will have an accumulated effect on all our tomorrows.", "author": "Alexandra Stoddard"},
    ...
    {"quote": "Do not wait; the time will never be 'just right'. Start where you stand, and work with whatever tools you may have at your command.", "author": "Napoleon Hill"},
    {"quote": "Do something today that your future self will thank you for.", "author": "Anonymous"},
    {"quote": "Do something today your future self will thank you for.", "author": "Anonymous"},
    ...
    {"quote": "If you can believe it, the mind can achieve it.", "author": "Anonymous"},
    ...
    {"quote": "Life is not about waiting for the storm to pass, but about learning to dance in the rain.", "author": "Vivian Greene"}
    ...
    {"quote": "What we do in life echoes in eternity.", "author": "Maximus Decimus Meridius"},
    {"quote": "What we do today, right now, will have an accumulated effect on all our tomorrows.", "author": "Alexandra Stoddard"},
    ...
    {"quote": "You are enough just as you are.", "author": "Bridget Jones"},
    ...
    {"quote": "You cannot start a new chapter of your life if you keep re-reading the last one.", "author": "Unknown"},
    ...
    {"quote": "You can’t use up creativity. The more you use, the more you have.", "author": "Mia Angelou"},
...
{"quote": "Act as if what you do makes a difference. It does.", "author": "William James"},
{"quote": "Believe in your dreams and they may come true; believe in yourself and they will come true.", "author": "Anonymous"},
{"quote": "Believe you can and you’re halfway there.", "author": "Theodore Roosevelt"},
{"quote": "Change your thoughts and you change your world.", "author": "Norman Vincent Peale"},
{"quote": "Do not wait to strike till the iron is hot, but make it hot by striking.", "author": "William Butler Yeats"},
{"quote": "Don't limit your challenges. Challenge your limits.", "author": "Anonymous"},
{"quote": "Don't wait for the perfect moment. Take the moment and make it perfect.", "author": "Anonymous"},
{"quote": "Don't watch the clock; do what it does. Keep going.", "author": "Sam Levenson"},
{"quote": "Don’t count the days, make the days count.", "author": "Muhammad Ali"},
{"quote": "Don’t stop when you’re tired. Stop when you’re done.", "author": "Anonymous"},
{"quote": "Don’t wait for opportunity. Create it.", "author": "Anonymous"},
...
{"quote": "Dream bigger. Do bigger.", "author": "Anonymous"},
{"quote": "Dream it. Wish it. Do it.", "author": "Anonymous"},
{"quote": "Every day may not be good, but there is something good in every day.", "author": "Anonymous"},
{"quote": "Everything you can imagine is real.", "author": "Pablo Picasso"},
{"quote": "Everything you’ve ever wanted is on the other side of fear.", "author": "George Addair"},
{"quote": "Great things never come from comfort zones.", "author": "Anonymous"},
{"quote": "If you can believe it, the mind can achieve it.", "author": "Anonymous"},
...
{"quote": "Success usually comes to those who are too busy to be looking for it.", "author": "Henry David Thau"},
{"quote": "Success usually comes to those who are too busy to be looking for it.", "author": "Henry David Thoreau"},
...
{"quote": "You are braver than you believe, stronger than you seem, and smarter than you think.", "author": "A.A. Milne"},
{"quote": "You are never too old to set another goal or to dream a new dream.", "author": "C.S. Lewis"},
{"quote": "You can’t fall if you don’t climb. But there’s no joy in living your whole life on the ground.", "author": "Anonymous"},
{"quote": "You can’t use up creativity. The more you use, the more you have.", "author": "Maya Angelou"},
{"quote": "You don’t have to be great to start, but you have to start to be great.", "author": "Zig Ziglar"},
{"quote": "You miss 100% of the shots you don’t take.", "author": "Wayne Gretzky"},
{"quote": "You must be the change you wish to see in the world.", "author": "Mahatma Gandhi"},
{"quote": "You must be the change you wish to see in the world.", "author": "Matma Gandhi"},
{"quote": "Your life does not get better by chance, it gets better by change.", "author": "Jim Rohn"},
{"quote": "Your limitation—it’s only your imagination.", "author": "Anonymous"},
{"quote": "Your time is limited, don’t waste it living someone else’s life.", "author": "Steve Jobs"}
               ]
